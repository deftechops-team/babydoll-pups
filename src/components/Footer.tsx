    ...
    <footer className="bg-secondary border-t border-border py-12">
      <div className="container mx-auto px-4">
        <div className="text-center mb-8">
          <h3 className="text-3xl text-foreground" style={{ fontFamily: "'Great Vibes', cursive" }}>Babydoll Pups</h3>
        ...
        <div className="border-t border-border pt-6 text-center">
          <p className="text-xs text-muted-foreground flex items-center justify-center gap-1">
            © {new Date().getFullYear()} Babydoll Pups. Made with <Heart className="w-3 h-3 text-primary fill-primary" /> All rights reserved.
          </p>
        </div>
      </div>
    </footer>
